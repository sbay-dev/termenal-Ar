...
namespace Microsoft::Console::Render::Atlas
{
    ...
    private:
        ...
        struct ApiState
        {
            ...
            // RTL-VT phase 1A: resolved bidi levels collected alongside script
            // runs. Populated only when the line contains at least one strong
            // RTL codepoint; remains empty for pure-LTR lines (zero overhead).
