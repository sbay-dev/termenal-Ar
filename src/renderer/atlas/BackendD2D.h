...
namespace Microsoft::Console::Render::Atlas
{
    ...
    private:
        ...
        ATLAS_ATTR_COLD f32 _drawBuiltinGlyphs(const RenderingPayload& p, const ShapedRow* row, const FontMapping& m, f32 baselineY, f32 baselineX, bool& rtlShiftApplied);
