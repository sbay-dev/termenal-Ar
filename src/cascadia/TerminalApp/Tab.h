...
namespace winrt::TerminalApp::implementation
{
    ...
    public:
        ...
        void SetContinuityPinned(bool pinned);
        void ToggleContinuityPinned();
        bool IsContinuityPinned() const noexcept;
    ...
    private:
        ...
        winrt::Windows::UI::Xaml::Controls::MenuFlyoutItem _continuityPinMenuItem{};
        ...
        bool _pinnedForContinuity{ false };
        ...
        void _UpdateContinuityPinMenuItem();
