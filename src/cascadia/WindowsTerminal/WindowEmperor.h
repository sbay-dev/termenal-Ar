...
private:
    ...
    void _persistState(const winrt::Microsoft::Terminal::Settings::Model::ApplicationState& state, bool persistContent) const;
    void _persistTerminalBuffers(bool cleanupStaleFiles) const;
