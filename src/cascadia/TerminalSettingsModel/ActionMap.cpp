...
#undef ON_ALL_ACTIONS_WITH_ARGS
    ...
    {
        if (action == ShortcutAction::ToggleTabContinuityPin)
        {
            return GetLibraryResourceLoader().ResourceMap().GetValue(USES_RESOURCE(L"ToggleTabContinuityPinCommandKey"), context).ValueAsString();
        }
