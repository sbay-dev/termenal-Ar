...
namespace winrt::Microsoft::Terminal::TerminalConnection::implementation
{
    struct ConptyConnection : ConptyConnectionT<ConptyConnection>, BaseTerminalConnection<ConptyConnection>
    {
        ...
        winrt::hstring CopilotAgentSessionId() const;
    ...
    private:
        ...
        static std::optional<std::wstring> _copilotSessionIdFromCommandline(std::wstring_view commandline);
        static std::optional<std::wstring> _environmentValueFromProcess(HANDLE process, std::wstring_view name);
        static std::vector<DWORD> _descendantProcessIds(DWORD rootProcessId);
